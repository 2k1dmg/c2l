...
**Р 8.2**  
В тексте приблизительно на 2% больше букв, а объём в байта меньше на 45% в сравнении с кириллицей.
	
**ASCII 6а**  
В тексте приблизительно на 7% больше букв, а объём в байта меньше на 47% в сравнении с кириллицей.
...
«**Р 2 ASCII 2в**» плюс этого варианта то, что есть мягкий знак, ~~а минус буква "**w**". Ещё есть буквы **q** и **x** которые трудно применить в этом варианте.~~ и не нужен третий.
