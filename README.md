...
- для "ъ" в некоторых случаях используется апостроф. При желании вместо апострофа для твёрдого знака в алфавит можно добавить букву "ĵ", а с физической клавиатуры набирается через AltGr + J или Ì
