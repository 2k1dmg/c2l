...
- "х" в начале слов и после гласных кроме "и" - "h" в остальных случаях "ch". Так лучше смотриться "их" - "ich" / "ih" 
- для "щ" - "ħ" лучше различается в тексте по сравнению с "ś ŝ"
- для "ы" в большинстве славянских языков используется "y"
- для "ь" вместо используется "ì" потому лучше подходит для имён. Например "Darìā Natalìā"
- йотированные гласные не пишутся в начале слов, а после тврёрдого знака заменяют "ъе ъё ъю ъя" на "je jo ju ja"
- мягкие согласные не используют из-за малой их частотности и увеличения алфавита. Лучше использвать йотированные галсные и мягкий знак
- после букв "ж ч ш щ" не пишутся "ь ё ю я". Легче читать
- для "ъ" в некоторых случаях используется апостроф
