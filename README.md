...
<details>
  <summary>«Р 8.2+ 3.8.2 ([тлнрсз]ь чш)»</summary>

- сочетание букв "сз" можно писать "sz" (к примеру как "е - ё")
...
**i** без точки, кроме сочетаний **ii ui** ?**vi**  
**j** без точки, кроме сочетаний **ij uj**
...
<details>
  <summary>Приблизительная частотность букв Р 8.2+ 3.8.3</summary>
...
| № - / " : , . _ ? % ! ;
  ħ c u k e n g š j z h ĵ
   f y v a p r o l d ž ě )
    ā č s m i t ì b ū ō
```	
[SCUKE5 (ЩЦУКЕ5)](https://raw.githubusercontent.com/2k1dmg/c2l/main/files/RuSCUKE5.klc) «**Р 8.4, Р 8.2+ 2/3**»
```
ħ c u k e n g š j z h ĵ
 f y v a p r o l d ž ě
  - č s m i t ì b , .
